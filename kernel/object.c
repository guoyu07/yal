 ...
 */
int yal_get_class_constant(zval *return_value, zend_class_entry *ce, char *constant_name, unsigned int constant_length TSRMLS_DC) {
 ...
 */
int yal_instance_of(zval *result, const zval *object, const zend_class_entry *ce TSRMLS_DC) {
 ...
 */
int yal_is_instance_of(zval *object, char *class_name, unsigned int class_length TSRMLS_DC) {
 ...
 */
void yal_get_class(zval *result, zval *object, int lower TSRMLS_DC) {
	...
	if (Z_TYPE_P(object) == IS_OBJECT) {
		...
		ZVAL_NULL(result);
		php_error_docref(NULL TSRMLS_CC, E_WARNING, "yal_get_class expects an object");
	}
}
 ...
 * Returns a class name into a zval result
 */
void yal_get_class_ns(zval *result, zval *object, int lower TSRMLS_DC) {
	...
	if (Z_TYPE_P(object) != IS_OBJECT) {
		if (Z_TYPE_P(object) != IS_STRING) {
			ZVAL_NULL(result);
			php_error_docref(NULL TSRMLS_CC, E_WARNING, "yal_get_class_ns expects an object");
			return;
		}
	}
 ...
 */
void yal_get_ns_class(zval *result, zval *object, int lower TSRMLS_DC) {
	...
	if (Z_TYPE_P(object) != IS_OBJECT) {
		if (Z_TYPE_P(object) != IS_STRING) {
			php_error_docref(NULL TSRMLS_CC, E_WARNING, "yal_get_ns_class expects an object");
			ZVAL_NULL(result);
			return;
		}
	}
 ...
 */
void yal_get_called_class(zval *return_value TSRMLS_DC) {
	...
	if (!EG(scope))  {
		php_error_docref(NULL TSRMLS_CC, E_WARNING, "yal_get_called_class() called from outside a class");
	}
 ...
 */
zend_class_entry *yal_fetch_class(zval *class_name TSRMLS_DC) {
 ...
 */
int yal_class_exists(zval *class_name TSRMLS_DC) {
 ...
 */
int yal_clone(zval *destiny, zval *obj TSRMLS_DC) {
 ...
 */
int yal_isset_property(zval *object, char *property_name, unsigned int property_length TSRMLS_DC) {
 ...
 * Checks if property exists on object
 */
int yal_isset_property_quick(zval *object, char *property_name, unsigned int property_length, unsigned long hash TSRMLS_DC) {
 ...
 */
int yal_isset_property_zval(zval *object, zval *property TSRMLS_DC) {
 ...
 *
 */
static inline zend_class_entry *yal_lookup_class_ce(zend_class_entry *ce, char *property_name, unsigned int property_length TSRMLS_DC) {
 ...
 *
 */
static inline zend_class_entry *yal_lookup_class_ce_quick(zend_class_entry *ce, char *property_name, unsigned int property_length, unsigned long hash TSRMLS_DC) {
 ...
 */
int yal_read_property(zval **result, zval *object, char *property_name, unsigned int property_length, int silent TSRMLS_DC) {
	...
	if (likely(Z_TYPE_P(object) == IS_OBJECT)) {
		...
		ce = Z_OBJCE_P(object);
		if (ce->parent) {
			ce = yal_lookup_class_ce(ce, property_name, property_length TSRMLS_CC);
		}
 ...
 */
int yal_read_property_this(zval **result, zval *object, char *property_name, unsigned int property_length, int silent TSRMLS_DC) {
 ...
 * Variables must be defined in the class definition. This function ignores magic methods or dynamic properties
 */
int yal_read_property_this_quick(zval **result, zval *object, char *property_name, unsigned int property_length, unsigned long key, int silent TSRMLS_DC) {
	...
	if (likely(Z_TYPE_P(object) == IS_OBJECT)) {
		...
		ce = Z_OBJCE_P(object);
		if (ce->parent) {
			ce = yal_lookup_class_ce_quick(ce, property_name, property_length, key TSRMLS_CC);
		}
 ...
 */
int yal_return_property(zval *return_value, zval *object, char *property_name, unsigned int property_length TSRMLS_DC) {
 ...
 * Returns an object's member
 */
int yal_return_property_quick(zval *return_value, zval *object, char *property_name, unsigned int property_length, unsigned long key TSRMLS_DC) {
 ...
 * Reads a property from an object
 */
int yal_read_property_zval(zval **result, zval *object, zval *property, int silent TSRMLS_DC) {
	...
	if (Z_TYPE_P(object) == IS_OBJECT) {
		if (Z_TYPE_P(property) == IS_STRING) {
			...
			ce = Z_OBJCE_P(object);
			if (ce->parent) {
				ce = yal_lookup_class_ce(ce, Z_STRVAL_P(property), Z_STRLEN_P(property) TSRMLS_CC);
			}
 ...
 */
int yal_update_property_long(zval *object, char *property_name, unsigned int property_length, long value TSRMLS_DC) {
 ...
 */
int yal_update_property_string(zval *object, char *property_name, unsigned int property_length, char *str, unsigned int str_length TSRMLS_DC) {
 ...
 */
int yal_update_property_bool(zval *object, char *property_name, unsigned int property_length, int value TSRMLS_DC) {
 ...
 */
int yal_update_property_null(zval *object, char *property_name, unsigned int property_length TSRMLS_DC) {
 ...
 */
int yal_update_property_zval(zval *object, char *property_name, unsigned int property_length, zval *value TSRMLS_DC){
 ...
 * Variables must be defined in the class definition. This function ignores magic methods or dynamic properties
 */
int yal_update_property_this(zval *object, char *property_name, unsigned int property_length, zval *value TSRMLS_DC){
 ...
 * Variables must be defined in the class definition. This function ignores magic methods or dynamic properties
 */
int yal_update_property_this_quick(zval *object, char *property_name, unsigned int property_length, zval *value, unsigned long key TSRMLS_DC){
 ...
 */
int yal_update_property_zval_zval(zval *object, zval *property, zval *value TSRMLS_DC){
 ...
 */
int yal_update_property_array(zval *object, char *property, unsigned int property_length, zval *index, zval *value TSRMLS_DC) {
	...
	if (likely(Z_TYPE_P(object) == IS_OBJECT)) {
		...
		yal_read_property(&tmp, object, property, property_length, PH_NOISY_CC);
		...
		if (separated) {
			yal_update_property_zval(object, property, property_length, tmp TSRMLS_CC);
		}
 ...
 */
int yal_update_property_array_string(zval *object, char *property, unsigned int property_length, char *index, unsigned int index_length, zval *value TSRMLS_DC) {
 ...
 */
int yal_update_property_array_append(zval *object, char *property, unsigned int property_length, zval *value TSRMLS_DC) {
 ...
 */
int yal_update_property_empty_array(zend_class_entry *ce, zval *object, char *property_name, unsigned int property_length TSRMLS_DC) {
 ...
 */
int yal_unset_property_array(zval *object, char *property, unsigned int property_length, zval *index TSRMLS_DC) {
 ...
 */
int yal_method_exists(zval *object, zval *method_name TSRMLS_DC){
 ...
 */
int yal_method_exists_ex(zval *object, char *method_name, unsigned int method_len TSRMLS_DC){
 ...
 * Check if method exists on certain object using explicit char param
 */
int yal_method_quick_exists_ex(zval *object, char *method_name, unsigned int method_len, unsigned long hash TSRMLS_DC){
 ...
 */
int yal_read_static_property(zval **result, char *class_name, unsigned int class_length, char *property_name, unsigned int property_length TSRMLS_DC){
	zend_class_entry **ce;
 ...
 */
int yal_update_static_property(char *class_name, unsigned int class_length, char *name, unsigned int name_length, zval *value TSRMLS_DC){
	zend_class_entry **ce;
	if (zend_lookup_class(class_name, class_length, &ce TSRMLS_CC) == SUCCESS) {
 ...
 */
int yal_update_static_property_nts(zend_class_entry *ce, char *name, unsigned int name_length, zval *value TSRMLS_DC){
	return zend_update_static_property(ce, name, name_length, value TSRMLS_CC);
}
 ...
 */
int yal_create_instance(zval *return_value, zval *class_name TSRMLS_DC){

	zend_class_entry *ce;

	if (Z_TYPE_P(class_name) != IS_STRING) {
		yal_throw_exception_string(yal_exception_ce, SL("Invalid class name") TSRMLS_CC);
		return FAILURE;
	}
	...
	if (yal_has_constructor(return_value TSRMLS_CC)) {
		if (yal_call_method(NULL, return_value, SL("__construct"), 0 PH_MEHASH_C TSRMLS_CC) == FAILURE) {
			return FAILURE;
		}
	}
 ...
 */
int yal_create_instance_params(zval *return_value, zval *class_name, zval *params TSRMLS_DC){
	...
	if (Z_TYPE_P(params) != IS_ARRAY) {
		yal_throw_exception_string(yal_exception_ce, SL("Instantiation parameters must be an array") TSRMLS_CC);
		return FAILURE;
	}
	...
	if (param_count > 0){
		...
		if (yal_has_constructor(return_value TSRMLS_CC)) {
			if (yal_call_method_params(NULL, return_value, SL("__construct"), (zend_uint) param_count, params_array, 0 PH_MEHASH_C TSRMLS_CC) == FAILURE) {
				efree(params_array);
				return FAILURE;
			}
		}
 ...
 */
int yal_property_incr(zval *object, char *property_name, unsigned int property_length TSRMLS_DC){
 ...
 */
int yal_property_decr(zval *object, char *property_name, unsigned int property_length TSRMLS_DC){
